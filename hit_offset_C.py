...
for i in range(1,17):
# --- Input / Output ---
    input_csv = f"filtered_events_eta_C/mdt_hits_within_offsets_per_layer_{i}.csv"
    output_csv = f"two_mezz_events_eta_C/mdt_hits_filtered_top2mezz_per_layer_{i}.csv"
